                    ...
                    <div class="form-group {!! $errors->has('number') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control"
                                   ...
                                   placeholder="Numéro"
                                   value="{!! old('number') ? old('number') : $stab->number !!}"
                    ...
                    <div class="form-group {!! $errors->has('brand') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                   name="brand" id="brand"
                                   placeholder="Marque"
                                   value="{!! old('brand') ? old('brand') : $stab->brand !!}"
                    ...
                    <div class="form-group {!! $errors->has('model') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                   name="model" id="model"
                                   placeholder="Modèle"
                                   value="{!! old('model') ? old('model') : $stab->model !!}"
                    ...
                    <div class="form-group {!! $errors->has('size') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="size"
                                   ...
                                   value="{!! old('size') ? old('size') : $stab->size !!}"
                    ...
                    <div class="form-group {!! $errors->has('buy.shop') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                   ...
                                   value="{!! old('buy.shop') ? old('buy.shop') : $stab->buy->shop !!}"
                    ...
                    <div class="form-group {!! $errors->has('buy.date') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control datepicker"
                                   ...
                                   value="{!! old('buy.date') ? old('buy.date') : $stab->buy->date->format('d/m/Y') !!}"
                    ...
                    <div class="form-group {!! $errors->has('buy.price') ? 'has-error' :'' !!}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="buy[price]"
                                   ...
                                   value="{!! old('buy.price') ? old('buy.price') : $stab->buy->price !!}"
