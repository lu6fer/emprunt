...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'usage'                    => 'Utilisation',
        'status_id'                => 'Statut',
        'owner_id'                 => 'Propriètaire',
        'phone_mob'                => 'Téléphone mobile',
        'phone_fix'                => 'Téléphone fixe',
        'phone_work'               => 'Téléphone professionnel',
        'licence'                  => 'Licence',
        'review_date'              => 'Date inspection',
        'reviewer_id'              => 'Visiteur',
        'review_id'                => 'Type de visite',
        'review_status_id'         => 'Etat de la visite',
        'ext_state_id'             => 'Etat extérieur',
        'int_state_id'             => 'Etat intérieur',
        'int_oil'                  => 'Huilage interne',
        'int_residue_id'           => 'Résidus',
        'valve_id'                 => 'Robinetterie',
        'valve_ring_id'            => 'Bague robinetterie',
        'neck_thread_id'           => 'Filetage col',
        'neck_thread_size_id'      => 'Mesure filetage col',
        'todo_maintenance_id'      => 'Entretien à faire',
        'performed_maintenance_id' => 'Entretien effectué',
        'previous_review_date'     => 'Date inspection précédente',
        'next_test_date'           => 'Date prochaine réépreuve',
        'comment'                  => 'Commentaire',
